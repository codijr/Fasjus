<?php 
    ...
    function css_files() {
        ...
        wp_enqueue_style('style', get_template_directory_uri().'/assets/css/contato.css', array(),'1.0.0', 'all');
        wp_enqueue_style('footer', get_template_directory_uri().'/assets/css/footer.css', array(),'1.0.0', 'all');
